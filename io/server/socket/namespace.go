...
var (
	NAMESPACE_RESERVED_EVENTS = anvil.NewSet("connect", "connection", "new_namespace")
)
...
type namespace struct {
	*StrictEmitter
	...
	_fns *anvil.Slice[NamespaceMiddleware]

	_cleanup xhttp.Callable
}
...
func MakeNamespace() Namespace {
	n := &namespace{
		...
		sockets:  &anvil.Map[SocketId, *Socket]{},
		_fns:     anvil.NewSlice[NamespaceMiddleware](),
		_cleanup: nil,
	}
...
func (n *namespace) Emitter() *StrictEmitter {
	return n.StrictEmitter
}

func (n *namespace) Sockets() *anvil.Map[SocketId, *Socket] {
	return n.sockets
}
...
func (n *namespace) Fns() *anvil.Slice[NamespaceMiddleware] {
	return n._fns
}
