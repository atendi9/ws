...
// SubSlice returns a sub-slice with bounds checking
// Automatically adjusts start and end to valid ranges
func SubSlice[S ~[]E, E any](s S, start int) S {
	n := len(s)
...
// Transform transforms each element and returns a new slice
func Transform[T, R any](vals []T, transform func(T) R) []R {
